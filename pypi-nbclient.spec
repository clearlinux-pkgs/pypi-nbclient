...
Source0  : https://files.pythonhosted.org/packages/a7/33/0c5ae5bce44ae44a07d8aefb5a00f1b2520d89e33a0f4b989e1fa914ce5e/nbclient-0.5.9.tar.gz
...
%prep
%setup -q -n nbclient-0.5.9
cd %{_builddir}/nbclient-0.5.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641457716
...
cp %{_builddir}/nbclient-0.5.9/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
