...
Source0  : https://files.pythonhosted.org/packages/4c/09/ca367efae271cef775345147c792f6c870d3a6ed5c410795c9754e710248/nbclient-0.8.0.tar.gz
...
%prep
%setup -q -n nbclient-0.8.0
cd %{_builddir}/nbclient-0.8.0
pushd ..
cp -a nbclient-0.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684868452
