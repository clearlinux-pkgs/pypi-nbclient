...
Source0  : https://files.pythonhosted.org/packages/00/bb/5c11c78351430b2aec4cb9e79b4df8c1815e7eb6c38848ff19e8eba317fa/nbclient-0.9.0.tar.gz
...
%prep
%setup -q -n nbclient-0.9.0
cd %{_builddir}/nbclient-0.9.0
pushd ..
cp -a nbclient-0.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699459856
