...
Source0  : https://files.pythonhosted.org/packages/01/21/917a25fbc2b37ed37135be97efb4c98526008505451ffa841adcd7d11ed5/nbclient-0.6.8.tar.gz
...
%prep
%setup -q -n nbclient-0.6.8
cd %{_builddir}/nbclient-0.6.8
pushd ..
cp -a nbclient-0.6.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662753350
