...
Source0  : https://files.pythonhosted.org/packages/9d/8a/c36a91676da7115753e46931d672f2fff6003f6b9e78fb2dee8e739b9dcd/nbclient-0.7.0.tar.gz
...
%prep
%setup -q -n nbclient-0.7.0
cd %{_builddir}/nbclient-0.7.0
pushd ..
cp -a nbclient-0.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665075018
