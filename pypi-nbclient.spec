...
Source0  : https://files.pythonhosted.org/packages/a6/21/44d5915f077e0180b56527c9df5f5e9fc038ea4036f918cb12a5576d4536/nbclient-0.6.3.tar.gz
...
%prep
%setup -q -n nbclient-0.6.3
cd %{_builddir}/nbclient-0.6.3
pushd ..
cp -a nbclient-0.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653345769
...
cp %{_builddir}/nbclient-0.6.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
