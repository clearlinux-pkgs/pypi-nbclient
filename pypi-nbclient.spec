...
Source0  : https://files.pythonhosted.org/packages/3e/89/cd8621865c68d7570371d137257566651cb259137879d65fb533bd183165/nbclient-0.5.13.tar.gz
...
%prep
%setup -q -n nbclient-0.5.13
cd %{_builddir}/nbclient-0.5.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647014790
...
cp %{_builddir}/nbclient-0.5.13/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
