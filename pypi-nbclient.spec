...
Source0  : https://files.pythonhosted.org/packages/18/eb/bf70d7c1f17fe890201f2472efebf37814eba1fdede1076886840c1fa5d6/nbclient-0.6.0.tar.gz
...
%prep
%setup -q -n nbclient-0.6.0
cd %{_builddir}/nbclient-0.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649807026
...
cp %{_builddir}/nbclient-0.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
