...
Version  : 0.6.5
Release  : 23
URL      : https://files.pythonhosted.org/packages/4d/7e/e97f65894b25f9b580bf1bed67726d01c146c0821fc367791cc7f2ce7521/nbclient-0.6.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/4d/7e/e97f65894b25f9b580bf1bed67726d01c146c0821fc367791cc7f2ce7521/nbclient-0.6.5.tar.gz
...
%prep
%setup -q -n nbclient-0.6.5
cd %{_builddir}/nbclient-0.6.5
pushd ..
cp -a nbclient-0.6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656599309
...
cp %{_builddir}/nbclient-0.6.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
