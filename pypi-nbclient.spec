...
%prep
%setup -q -n nbclient-0.6.4
cd %{_builddir}/nbclient-0.6.4
pushd ..
cp -a nbclient-0.6.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656392532
...
cp %{_builddir}/nbclient-0.6.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
