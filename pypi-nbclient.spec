...
Source0  : https://files.pythonhosted.org/packages/d4/5c/557319436a2a1d8f336a292728a7698e376698bd27479c9fde7b32c2d986/nbclient-0.5.10.tar.gz
...
%prep
%setup -q -n nbclient-0.5.10
cd %{_builddir}/nbclient-0.5.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642180049
...
cp %{_builddir}/nbclient-0.5.10/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
