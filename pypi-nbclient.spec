...
Source0  : https://files.pythonhosted.org/packages/16/53/4f3ce1dc291ff818c10ff1fcec34a9a7eca404a174d6012dd660629d33e9/nbclient-0.6.7.tar.gz
...
%prep
%setup -q -n nbclient-0.6.7
cd %{_builddir}/nbclient-0.6.7
pushd ..
cp -a nbclient-0.6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661275851
