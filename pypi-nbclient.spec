...
Source0  : https://files.pythonhosted.org/packages/87/66/7ffd18d58eae90d5721f9f39212327695b749e23ad44b3881744eaf4d9e8/nbclient-0.10.2.tar.gz
...
%prep
%setup -q -n nbclient-0.10.2
cd %{_builddir}/nbclient-0.10.2
pushd ..
cp -a nbclient-0.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735097284
