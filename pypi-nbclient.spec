...
Source0  : https://files.pythonhosted.org/packages/39/24/6c9b982d7adacf87f3950034b206e57d38b1800bde1db6a068b6a4503a7e/nbclient-0.5.11.tar.gz
...
%prep
%setup -q -n nbclient-0.5.11
cd %{_builddir}/nbclient-0.5.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644890543
...
cp %{_builddir}/nbclient-0.5.11/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
